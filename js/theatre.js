...
if (document.querySelector("[data-theatre-section]")) {
  ...
  var theatrePlaybillPanel = document.querySelector("[data-theatre-playbill-panel]");
  var sideMenuOpenBtn = document.querySelector("[data-up-next-sidebar-open-btn]");

  var slideInPlaybillPanelDuration = parseInt(getCSSPropertyValueFromRoot("--THEATRE-PAGE-slide-in-playbill-panel-duration"));
  ...
  function slideCharactersSeatsIn() {
    ...
    setTimeout(() => {
      theatrePlaybillPanel.classList.add("transition-delay-0");
    }, slideInPlaybillPanelDuration);

    sideMenuOpenBtn.classList.add("slide-in");
  }
